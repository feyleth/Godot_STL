...
def build_gles2_headers(source):
    build_legacygl_header(
        str(source), include="drivers/gles2/shader_gles2.h", class_suffix="GLES2", output_attribs=True, gles2=True
    )
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        exit(-1)
    build_gles2_headers(sys.argv[1])