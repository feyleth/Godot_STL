...
def build_gdnative_api_struct(header, source, filejson):

    with open(filejson, 'r') as fd:
        api = json.load(fd)
...
if __name__ == '__main__':
    if len(sys.argv) < 4:
        print("usage : " + sys.argv[0] + " <header> <source> <filejson>")
        exit()
    build_gdnative_api_struct(sys.argv[1],sys.argv[2],sys.argv[3])
